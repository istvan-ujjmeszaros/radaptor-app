			...
			'core' => [
				'framework' => [
					...
					'resolved' => [
						...
						'dist_url' => 'https://packages.example.invalid/packages/radaptor-core-framework/0.1.13/plugin.zip',
						'dist_sha256' => 'abc123',
				...
				'cms' => [
					...
					'resolved' => [
						...
						'registry' => 'default',
						'registry_url' => 'https://packages.example.invalid/registry.json',
						'dist_url' => 'https://packages.example.invalid/packages/radaptor-core-cms/0.1.6/plugin.zip',
						'dist_sha256' => 'def456',
				...
				$packages[$packageName] = [
					...
					'versions' => [
						$latestVersion => [
							...
							'dist' => [
								'type' => 'zip',
								'url' => 'packages/radaptor-core-framework/' . $latestVersion . '/plugin.zip',
								'sha256' => 'abc123',
							],
						],
					],
				...
				$packages[$packageName] = [
					...
					'versions' => [
						$latestVersion => [
							...
							'dist' => [
								'type' => 'zip',
								'url' => 'packages/radaptor-core-cms/' . $latestVersion . '/plugin.zip',
								'sha256' => 'def456',
							],
						],
					],
